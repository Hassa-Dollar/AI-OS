...
<!-- AUTO-SHIPPED:BEGIN — generated by scripts/handoff.sh @ 2026-06-23T20:49:23Z; do not hand-edit -->
...
<!-- AUTO-STATE:BEGIN — generated by scripts/handoff.sh @ 2026-06-23T20:49:22Z; do not hand-edit -->
- **main:** `07fa0d4 Merge pull request #39 from Hassa-Dollar/fix/registry-generated-view`
- **checked-out branch:** `main` · worktree: clean
- **active task specs:** none · completed: 1
- **open PRs:** none
- **last ledger events:**
```
2026-06-20T23:08:50Z,land,harden,main,hassa,"branch=chore/harden-harness main=da341a64"
2026-06-21T19:13:40Z,land,harden,main,hassa,"branch=chore/harden-integration-tests main=897d66c0"
2026-06-22T00:13:05Z,land,memory,main,hassa,"branch=feat/memory-db-v1 main=0362236d"
...
<!-- AUTO-INVENTORY:BEGIN — generated by scripts/handoff.sh @ 2026-06-23T20:49:23Z; do not hand-edit -->
**Components (the deliverables built by the system):**
- `api` → profile `?`
- `service` → profile `(no .component.yml)`
- `web` → profile `?`
