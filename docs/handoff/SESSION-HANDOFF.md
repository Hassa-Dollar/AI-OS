...
**AI-Dev-OS** — a scarce premium model (the **Lead** — operator-chosen, ADR-0025; currently **Claude Fable 5**) produces specs, contracts, and
...
<!-- AUTO-STATE:BEGIN — generated by scripts/handoff.sh @ 2026-07-15T18:26:28Z; do not hand-edit -->
- **main:** `c2c3d93 Merge pull request #80 from Hassa-Dollar/task/OS-V1-worker-logs-status`
- **checked-out branch:** `main` · worktree: clean
- **active task specs:** tasks/active/T05-redirect-click.md · completed: 5
- **open PRs:** none
- **last ledger events:**
```
2026-07-15T16:30:39Z,dispatch,OS-V1,task/OS-V1-worker-logs-status,hassa,"model=opencode-go/glm-5.2 verifier=opencode-go/deepseek-v4-pro branch=task/OS-V1-worker-logs-status"
2026-07-15T18:02:28Z,qa,OS-V1,task/OS-V1-worker-logs-status,hassa,"verifier=opencode-go/deepseek-v4-pro risk=low verdict=pass files=10 lines=933"
2026-07-15T18:11:11Z,qa,OS-V1,task/OS-V1-worker-logs-status,hassa,"verifier=opencode-go/deepseek-v4-pro risk=low verdict=pass files=10 lines=933"
2026-07-15T18:11:43Z,opus-gate,OS-V1,task/OS-V1-worker-logs-status,hassa,"draft-pr=https://github.com/Hassa-Dollar/AI-OS/pull/80 tier=OPERATOR flags=lines>350"
2026-07-15T18:25:25Z,opus-gate,OS-V1,task/OS-V1-worker-logs-status,hassa,"lead-approved branch=task/OS-V1-worker-logs-status"
2026-07-15T18:26:27Z,land,OS,main,hassa,"branch=task/OS-V1-worker-logs-status main=c2c3d93e"
```
<!-- AUTO-STATE:END -->
...
<!-- AUTO-SHIPPED:BEGIN — generated by scripts/handoff.sh @ 2026-07-15T18:26:28Z; do not hand-edit -->
- **OS-V1 — worker-logs-status** → completed
- **T01 — api-scaffold** → completed
- **T02 — db-layer** → completed
- **T03 — better-auth** → completed
- **T04 — links-crud** → completed
<!-- AUTO-SHIPPED:END -->
...
- **The Lead** is the operator-chosen frontier model (ADR-0025; currently **Claude Fable 5**) — scarce, never a workforce model.
- **Diagram:** `docs/handoff/ai-dev-os-build-loop.svg` (text version below).

```mermaid
flowchart TD
    H["HUMAN OPERATOR<br/>direction · approvals · taste"]
    L["THE LEAD · operator-chosen frontier model<br/>plan · contracts · review-gate · debug<br/>(scarce message budget)"]
