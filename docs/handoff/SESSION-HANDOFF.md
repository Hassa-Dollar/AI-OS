...
<!-- AUTO-STATE:BEGIN — generated by scripts/handoff.sh @ 2026-06-25T17:11:24Z; do not hand-edit -->
- **main:** `f853c8d Merge pull request #46 from Hassa-Dollar/fix/stale-config-refs`
- **checked-out branch:** `fix/remove-dead-files` · worktree: DIRTY (expected right after handoff.sh ran — the refresh itself is the diff; it rides along with the next PR)
...
2026-06-25T16:41:52Z,land,handoff,main,hassa,"branch=fix/handoff-durable main=655583d9"
2026-06-25T17:02:27Z,land,stale,main,hassa,"branch=fix/stale-config-refs main=f853c8de"
```
<!-- AUTO-STATE:END -->
...
<!-- AUTO-SHIPPED:BEGIN — generated by scripts/handoff.sh @ 2026-06-25T17:11:24Z; do not hand-edit -->
